    ...
    newwindow.document.write(
      "<link rel='stylesheet' href='resources/bootstrap/css/bootstrap.min.css'>"+
        "<div>"+ "<h3>" + "Subhashi Printers" + "</h3>" +
           " <h4>" + "Report - Customer Orders According to Time Period" + "</h4>" + "<br>"+
       " </div>"+ "<br>"+
        "<div>" + tablehtml + "</div>"
    )
    setTimeout(function (){
...
function  generateReport(){
    corderPReport = getServiceRequest("customerOrderPatternReport/bysdateedate/ "+dteStartDate.value+ "/"+dteEndDate.value+"/" +selectReportType.value);
    ...
    //called filldataintotable function for fill data
    fillDataIntoTable(tableCustomerOrderPatternReport,corderPReport, displayPropertyList, displayDatatypeList, formRefill, rowDelete, rowView, false, lggeduserprivilage);
